Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/luo6luo/AFNetworking'
  s.social_media_url = 'https://twitter.com/AFNetworking'
  s.authors  = { 'Mattt Thompson' => 'm@mattt.me' }
  s.source   = { :git => 'https://github.com/luo6luo/AFNetworking.git', :tag => s.version }
  ...
  s.subspec 'Resources' do |ss|
    ss.source_files = 'Resources/PrivacyInfo.xcprivacy'
  end
end
